    ...
    <div >
      ...
      <div className=" mx-auto my-24">
        <div className="md:flex items-center justify-evenly ">
          <div className="max-w-2xl h-96 rounded-xl -rotate-6 transform shadow-lg  overflow-hidden">
            <img
          ...
          <div className="max-w-4xl  overflow-y-scroll  scrollbar-hide p-3" style={{height: 600}}>
            ...
            <div className="my-10">
              ...
              <div className="ml-8 mt-2">
                <div className="flex justify-center">
                  <FaCheckCircle className="text-5xl text-red-600 mr-3" />
                  <p className="leading-7">
            ...
            <div className="my-10">
              ...
              <div className="my-2">
                <p className="font-medium">
                  As we know from previous decentralised urbanisation projects,
                  the success is not just determined by physical planning and
                  economic stimulus, but equally by community building.
                  Community building and social innovation are to be at the
                  heart of decentralised healthy urbanisation. In the last
                  century this was organized top-down and rather paternalistic.
                  Therefore we integrated the ABCD method in the Global
                  Knowledge Cities concept to address and organize cocreation
                  effectively.
                </p>
              </div>
            </div>
            <div className="my-10">
              ...
              <div className="ml-8 mt-2">
                <div className="flex ">
                  <h1 className="text-red-600 text-xl font-bold">A</h1>
                  <p className="leading-7 ml-4">for Administration,</p>
                </div>
                <div className="flex ">
                  <h1 className="text-red-600 text-xl font-bold">B</h1>
                  <p className="leading-7 ml-4">for Businesses,</p>
                </div>
                <div className="flex ">
                  <h1 className="text-red-600 text-xl font-bold">C</h1>
                  <p className="leading-7 ml-4">
                    for Civil service and Knowledge institutions and
                  </p>
                </div>
                <div className="flex ">
                  <h1 className="text-red-600 text-xl font-bold">D</h1>
                  <p className="leading-7 ml-4">
